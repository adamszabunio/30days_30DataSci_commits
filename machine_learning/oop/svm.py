...
class Support_Vector_Machine():
    ...
    def fit(self, data):
        ...
        # { ||w||: [w, b]}
        opt_dict = {}
        # since this is a quadratic optimization, need 4 combiniations
	...
	# merge all data into one list
        ...
        all_data = None # no need to store this in memory

        step_sizes = [self.max_feature_value * 0.1,
                      self.max_feature_value * 0.01,
		    # starts to get very expensive with very small steps, but also more precise
                      self.max_feature_value * 0.001]

        # finding the optimal b is also very expensive
        b_range_multiple = 2 # for sake of runtime, just hardcode b
	# take much larger steps for b than w (not as important as w)
        b_multiple = 5
